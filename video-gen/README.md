...
# Zeroscope 모델 사용
uv run python generate.py -p "ocean waves crashing on rocks" -m zeroscope

# 커스텀 설정
uv run python generate.py -p "a girl dancing in the rain" \
...
# Zeroscope 고품질 설정
uv run python generate.py -p "astronaut floating in space" \
